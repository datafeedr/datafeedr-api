...
/**
 * Autoloads Datafeedr API classes.
 *
 * @since 2.0.0
 */
class Autoloader {
	...
	/**
	 * Handles the autoloading of the Datafeedr API classes.
	 *
	 * @since 2.0.0
	 *
	...
	function autoload( $class_name ) {
		...
		// If $class_name does not contain the Datafeedr\Api namespace, return. It's not our class.
		...
		// Remove namespace "Datafeedr\Api" from $class_name
		...
		// Get full path to classes directory: ~/wp-content/plugins/datafeedr-api-v2/src
		$classes_dir = untrailingslashit( dirname( __FILE__ ) );
